...
const Hero = () => {
  ...
  // form state for certificate info
  const [formData, setFormData] = useState({
    fullName: "",
    course: "",
    provider: "",
  ...
  // Handle Download → fake certificate download, then show payment panel
  const handleDownloadClick = () => {
    setCertificateReady(false);
    setDownloading(true);
          ...
          custom_fields: [
            {
              ...
              value: paymentData.name, // dynamic name
            },
            {
              display_name: "Phone Number",
              variable_name: "phone_number",
              value: paymentData.phone, // dynamic phone
            },
          ],
        },
        callback: function (response) {
  ...
  return (
    ...
    >
      ...
      {showForm && (
        <div className="fixed inset-0 bg-yellow-500 bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white rounded-lg shadow-lg w-100 p-6 relative text-center text-black animate-slideDown mx-5">
            <button
              onClick={closeForm}
              className="absolute top-2 right-2 text-gray-500 hover:text-red-800 cursor-pointer hover:bg-red-400"
            >
              <X size={20} />
            </button>
            <h3 className="text-xl mb-4 italic">
            ...
            <form onSubmit={handleFormSubmit} className="space-y-2">
              ...
              <button
                type="submit"
                className="bg-yellow-600 hover:bg-yellow-700 text-white px-6 py-2 rounded-lg shadow-md font-semibold w-full active:bg-yellow-400"
              >
                Continue
              </button>
            </form>
      ...
      {showPanel && (
        <div className="fixed inset-0 bg-yellow-500 bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white rounded-lg shadow-lg w-96 p-6 relative text-center px-4 mx-4">
            <button
              onClick={closePanel}
              className="absolute top-2 right-2 text-gray-500 hover:text-gray-800 cursor-pointer hover:bg-red-400"
            >
              <X size={20} />
            </button>
            ...
            <p className="font-medium mb-4 text-red-800">
              ❌ Oops! Download was disabled. You need to pay for your
              certificate first.
            </p>

            <p className="text-gray-800 italic mb-3">
              Fill in your payment info below
            </p>

            <form
              onSubmit={handlePaystackPayment}
              className="space-y-4 text-left text-black"
            >
              <input
                type="text"
                placeholder="Your full Name"
                ...
                required
                className="w-full border rounded-lg px-3 py-2 bg-white focus:ring-2 focus:ring-yellow-400 outline-none"
              />
              <input
                type="email"
              ...
              <button
                type="submit"
                className="bg-yellow-500 hover:bg-yellow-600 text-white px-6 py-2 rounded-lg shadow-md font-semibold w-full active:bg-yellow-400"
              >
                Proceed to Pay 💳
              </button>
            </form>
